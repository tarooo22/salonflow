...
ALTER TABLE `commission_entries` ADD CONSTRAINT `commission_entries_appointmentServiceId_appointment_services_id_fk` FOREIGN KEY (`appointmentServiceId`) REFERENCES `appointment_services`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
