...
export default function Today() {
  ...
  return <DashboardLayout><div className="sf-workspace-page mx-auto w-full max-w-7xl space-y-5">
    ...
    {showAccessExpiryReminder ? <section role="status" className="flex flex-col gap-3 rounded-2xl border border-[color-mix(in_srgb,var(--sf-salon-warm)_40%,transparent)] bg-[color-mix(in_srgb,var(--sf-salon-warm)_9%,transparent)] p-4 sm:flex-row sm:items-center sm:justify-between"><div><p className="font-semibold">პაკეტის წვდომა იწურება {activeAccessDaysRemaining} დღეში</p><p className="mt-1 text-sm leading-6 text-muted-foreground">წვდომის დასრულებამდე შეგიძლიათ წინასწარ გახსნათ 1-თვიანი პაკეტის ინსტრუქცია, რათა სამუშაო პროცესი არ შეწყდეს.</p></div><Button asChild variant="outline" className="shrink-0"><Link href="/app/billing">პაკეტის ნახვა</Link></Button></section> : null}
