...
export default function InviteAccept() {
  ...
  const preview = trpc.organizations.previewStaffInvite.useQuery({ token }, { enabled: Boolean(token), retry: false });
