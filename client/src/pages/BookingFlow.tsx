...
export function StaffStep({ team, selectedId, onSelect }: { team: BookingTeamMember[]; selectedId?: string; onSelect: (id: string) => void }) {
...
export function TimeStep({ dateTime, onChange, availability }: { dateTime: string; onChange: (value: string) => void; availability: { isLoading: boolean; isError: boolean; data?: { available: boolean; reason?: string } } }) {
