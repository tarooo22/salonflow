...
export default function Home() {
  return <div className="min-h-screen bg-[#F7F4EF] text-[#1E2824]">
    <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-5 py-5 sm:px-8">
      ...
      <div className="flex items-center gap-3"><Link href="/app/today" className="hidden text-sm font-medium text-[#45514B] sm:block">სამუშაო სივრცე</Link><Button asChild className="bg-[#B85C3D] hover:bg-[#9D4C31]"><Link href="/app/today">შესვლა</Link></Button></div>
    </header>
    <main>
