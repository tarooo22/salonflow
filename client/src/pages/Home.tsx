    ...
    <main id="main-content" ref={revealRef} tabIndex={-1}>
      <section className="sf-salon-section"><div className="sf-public-container relative grid gap-12 pb-20 pt-14 lg:grid-cols-[1.03fr_.97fr] lg:items-center lg:pb-28 lg:pt-24">
        ...
        <div className="relative">
          ...
          <div className="sf-salon-cta-row mt-9"><Button asChild variant="public" size="lg"><Link href="/salons" data-conversion-event="DISCOVERY_SEARCH_SUBMITTED">იპოვე სალონი <Search className="size-4" aria-hidden="true" /></Link></Button><Button asChild variant="publicSecondary" size="lg"><Link href="/register" data-conversion-event="OWNER_CTA_SELECTED">ვმართავ სალონს <ChevronRight className="size-4" aria-hidden="true" /></Link></Button></div>
