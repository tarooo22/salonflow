    ...
    <main id="main-content" ref={revealRef} tabIndex={-1}>
      <section className="sf-salon-section"><div className="sf-public-container relative grid gap-12 pb-20 pt-14 lg:grid-cols-[1.03fr_.97fr] lg:items-center lg:pb-28 lg:pt-24">
        ...
        <div className="relative">
          ...
          <h1 className="sf-display mt-5 max-w-3xl text-[2.4rem] font-semibold leading-[0.98] sm:text-6xl lg:text-7xl">სალონის დღე — <span className="sf-gradient-text">თავისი რიტმით</span>.</h1>
          <p className="mt-7 max-w-xl text-lg leading-8 text-[var(--sf-muted)]">SalonFlow აერთიანებს ონლაინ ჩაწერას, კალენდარს, გუნდს, კლიენტებსა და ყოველდღიურ კონტროლს ერთ მშვიდ, ქართულ სამუშაო სივრცეში.</p>
          <div className="sf-salon-cta-row mt-9"><Button asChild variant="public" size="lg"><Link href="/register">მე ვმართავ სალონს <ArrowRight className="size-4" aria-hidden="true" /></Link></Button><Button asChild variant="publicSecondary" size="lg"><Link href="/book">მინდა ონლაინ ჩაწერა <ChevronRight className="size-4" aria-hidden="true" /></Link></Button></div>
          <p className="mt-5 inline-flex items-center gap-2 text-sm text-[var(--sf-muted)]"><LockKeyhole className="size-4 text-[var(--sf-jade)]" aria-hidden="true" /> ადგილობრივი ანგარიში · როლზე დაფუძნებული წვდომა · server-side დროის შემოწმება</p>
        </div>
