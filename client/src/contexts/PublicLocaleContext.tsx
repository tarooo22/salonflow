...
const copy = {
  ...
  en: {
    skip: "Skip to main content", mainNav: "Main navigation", mobileNav: "Mobile navigation", closeMenu: "Close menu", openMenu: "Open menu", features: "Features", pricing: "Pricing", preview: "Preview", faq: "FAQ", contact: "Contact", salons: "Salons", onlineBooking: "Online booking", book: "Book", signIn: "Sign in", startFree: "Get started", start: "Start", installApp: "Install app", product: "Product", information: "Information", workspaceCreate: "Create workspace", workspaceLogin: "Workspace sign in", footer: "Georgian-first interface · secure local account",
  ...
  ru: {
    skip: "Перейти к основному содержанию", mainNav: "Главная навигация", mobileNav: "Мобильная навигация", closeMenu: "Закрыть меню", openMenu: "Открыть меню", features: "Возможности", pricing: "Тарифы", preview: "Обзор", faq: "Вопросы", contact: "Контакты", salons: "Салоны", onlineBooking: "Онлайн-запись", book: "Записаться", signIn: "Войти", startFree: "Начать", start: "Начать", installApp: "Установить приложение", product: "Продукт", information: "Информация", workspaceCreate: "Создать рабочее пространство", workspaceLogin: "Вход в рабочее пространство", footer: "Интерфейс на грузинском · безопасная локальная учётная запись",
